...
def get_historical_data(ticker_symbol: str, time_period: str, time_interval: str) -> yf.Ticker:
    ...
    :param ticker_symbol: stock ticker to get historical data for
    :param time_period: time period to get historical data for, Valid Periods: 1d, 5d, 1mo,3mo,6mo,1y,2y,5y,10y,ytd,maxi
    :param time_interval: time interval to get historical data for,  Valid Periods: 1m , 2m, 5m, 15m, 30m, 60m, 90m, 1h, 1d, 5d, 1wk, 1mo, 3mo
    '''
